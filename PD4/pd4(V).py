...
def Populate (MDS, UREG):
	...
	product_row = {'ManufacturedDate':product1.getManufacturingDate(), 'modelNumber':product1.getModelNumber(), 'Length':product1.getLength(), 'Width':product1.getWidth(), 'Weight':product1.getWeight(), 'Cell_Area':product1.getCellArea(), 'Cell_Technology':product1.getCellTechnology(), 'Total_num_cell':product1.getTotalNumberofCells(), 'Num_of_cell_series':product1.getTotalNumberofCells(), 'Num_of_series':product1.getSeriesStrings(), 'Num_of_diodes':product1.getnumberofbypassdiodes(), 'Series_fuse_rating':product1.getseriesfuserating(), 'Interconnect_material':product1.getinterconnectmaterial(), 'Interconnect_supplier':product1.getinterconnectsupplier(), 'Superstrate_type':product1.getsuperstratetype(), 'Superstrate_manu':product1.getsuperstratemanufacturer(), 'Substrate_type':product1.getsuperstratetype(), 'Substrate_manu':product1.getsuperstratemanufacturer(), 'Frame_material':product1.getjunctionboxadhesive(), 'Frame_adhesive':product1.getjunctionboxadhesive(), 'Encapulant_type':product1.getjunctionboxtype(), 'Encapsulant_manu':product1.getjunctionboxadhesive(), 'Junction_box_type':product1.getjunctionboxtype(), 'Junction_box_manu':product1.getjunctionboxmanufacturer(), 'Junction_box_adhesive':product1.getjunctionboxadhesive(), 'Cable_type':product1.getcabletype(), 'Connector_type':product1.getconnnectortype(), 'Max_system_voltage':product1.getmaxsysvoltage(), 'ISC':product1.getratedisc(),'VOC':product1.getratedvoc(), 'IMP':product1.getratedimp(), 'VMP':product1.getratedvmp(), 'FF':product1.getratedff(), 'PMP':product1.getratedpmp()}
	...
	for i in dict_list:
		test = myClasses.TestResults(i)
		result_row = {'Lab_name':lab.getName(), 'Test_date':test.getTestDate(), 'reportingCondition':test.getReportingConditon(), 'NOCT':test.getNoct(), 'ISC':test.getIsc(), 'VOC':test.getVoc(), 'PMP':test.getPmp(), 'FF':test.getFF(), 'VMP':test.getVmp(), 'IMP':test.getImp()}
