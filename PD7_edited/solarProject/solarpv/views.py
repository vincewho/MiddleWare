...
def testp(request):
	...
	#path = 'C:\cygwin64\home\Ashley\virtualenvs\myproject_env2\PD7\solarProject\media\uploads'
	try:
		file = open('C:\\cygwin64\\home\\Ashley\\virtualenvs\\myproject_env2\\PD7\\solarProject\\media\\uploads\\test_results.csv')
		data = file.readlines()
		datalist = []
		newdata = []
		for i in data:
	...
	context = {'form': form, 'files': file, 'datalist': datalist}
